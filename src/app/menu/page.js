...
const menuItems = [
  ...
  { id: 7, title: "1 Falafel Sandwich", price: 6.49, description: "3 FALAFEL PIECES, YOUR CHOICE OF TOPPINGS, TAHINI SAUCE", section: "sandwiches" },
  { id: 8, title: "2 Falafel Sandwiches", price: 11.99, description: "3 FALAFEL PIECES, YOUR CHOICE OF TOPPINGS, TAHINI SAUCE", section: "sandwiches" },
  { id: 9, title: "Chicken Shawarma Plate", price: 13.99, description: "CHICKEN, YOUR CHOICE OF TOPPINGS, RICE, HUMMUS, TAHINI AND GARLIC SAUCES, PITA", section: "plates" },
  { id: 10, title: "Beef Shawarma Plate", price: 14.99, description: "BEEF, YOUR CHOICE OF TOPPINGS, RICE, HUMMUS, TAHINI SAUCE, PITA", section: "plates" },
  { id: 11, title: "Mix Shawarma Plate", price: 14.99, description: "MIX CHICKEN & BEEF, YOUR CHOICE OF TOPPINGS, RICE, HUMMUS, TAHINI AND GARLIC SAUCES, PITA", section: "plates" },
  { id: 12, title: "Chicken Shawarma Plate with Fries", price: 13.99, description: "CHICKEN, FRIES, PICKLES & TURNIPS, TAHINI AND GARLIC SAUCES, PITA", section: "plates" },
  { id: 13, title: "Beef Shawarma Plate with Fries", price: 14.99, description: "BEEF, FRIES, PICKLES & TURNIPS, TAHINI AND GARLIC SAUCES, PITA", section: "plates" },
  { id: 14, title: "Mix Shawarma Plate with Fries", price: 14.99, description: "MIX CHICKEN & BEEF, FRIES, PICKLES & TURNIPS, TAHINI AND GARLIC SAUCES, PITA", section: "plates" },
  { id: 15, title: "Falafel Plate", price: 11.99, description: "5 FALAFEL PIECES, YOUR CHOICE OF TOPPINGS, RICE, TAHINI SAUCE, PITA", section: "plates" },
  { id: 16, title: "Mojadarah Plate", price: 7.49, description: "LENIL RICE, YOUR CHOICE OF TOPPINGS (SALAD), TAHINI SAUCE, PITA", section: "plates" },
  ...
  { id: 35, title: "Canned Pop", price: 1.99, description: "", section: "drinks" },
  { id: 36, title: "Vimto", price: 1.99, description: "", section: "drinks" },
  { id: 37, title: "Bottled Drink", price: 3.75, description: "", section: "drinks" },
  { id: 38, title: "Ayran", price: 4.49, description: "", section: "drinks" },
  { id: 39, title: "Water", price: 1.99, description: "", section: "drinks" },
